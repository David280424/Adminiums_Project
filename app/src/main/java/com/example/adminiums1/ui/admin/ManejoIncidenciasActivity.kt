...
class ManejoIncidenciasActivity : AppCompatActivity() {
    ...
    private fun cargarIncidencias(estado: String) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                binding.toolbar.title = "Gestión de Incidencias (${lista.size})"
            }
        }
    }
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                if (exito) {
                    dialog.dismiss()
                    cargarIncidencias("Todas")
                    Toast.makeText(this@ManejoIncidenciasActivity, "Incidencia actualizada a $estado", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
