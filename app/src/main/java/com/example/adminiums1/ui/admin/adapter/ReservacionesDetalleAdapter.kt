...
// ─────────────────────────────────────────────────────────────────────────────
// ARCHIVO: ReservacionesDetalleAdapter.kt
// RUTA: ui/admin/adapter/ReservacionesDetalleAdapter.kt
// ─────────────────────────────────────────────────────────────────────────────
...
class ReservacionesDetalleAdapter : RecyclerView.Adapter<ReservacionesDetalleAdapter.VH>() {
    private var lista: List<Reservacion> = emptyList()
    fun setDatos(d: List<Reservacion>) { lista = d; notifyDataSetChanged() }
